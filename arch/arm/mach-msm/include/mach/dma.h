...
/* For pre-7x30, only security domain 3 is available to the Apps CPU
 * SD0 -> mARM trusted, SD1 -> mARM nontrusted, SD2 -> aDSP, SD3 -> aARM
 *
 * For 7x30, security domain 2 is used for the Apps CPU
 */

#if defined(CONFIG_ARCH_MSM7X30)
#define DMOV_SD_AARM(off, ch) DMOV_SD2(off, ch)
#else
#define DMOV_SD_AARM(off, ch) DMOV_SD3(off, ch)
#endif
