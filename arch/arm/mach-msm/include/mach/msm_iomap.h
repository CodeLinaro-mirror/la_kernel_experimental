...
#define _PHYS(a11,qsd8x50,msm7x30) (a11)
#elif defined(CONFIG_ARCH_QSD8X50)
#define _PHYS(a11,msm7x30,qsd8x50) (qsd8x50)
#elif defined(CONFIG_ARCH_MSM7X30)
#define _PHYS(a11,msm7x30,qsd8x50) (msm7x30)
#else
#error Unknown platform
#endif

#define MSM_VIC_BASE          IOMEM(0xF8000000)
#define MSM_VIC_PHYS          _PHYS(0xC0000000,0xC0080000,0xAC000000)
#define MSM_VIC_SIZE          SZ_4K

#define MSM_CSR_BASE          IOMEM(0xF8001000)
#define MSM_CSR_PHYS          _PHYS(0xC0100000,0xC0100000,0xAC100000)
...
#define MSM_DMOV_PHYS         _PHYS(0xA9700000,0xAC400000,0xA9700000)
#define MSM_DMOV_SIZE         SZ_4K

#define MSM_GPIO1_BASE        IOMEM(0xF8003000)
#define MSM_GPIO1_PHYS        _PHYS(0xA9200000,0xAC001000,0xA9000000)
#define MSM_GPIO1_SIZE        SZ_4K

#define MSM_GPIO2_BASE        IOMEM(0xF8004000)
#define MSM_GPIO2_PHYS        _PHYS(0xA9300000,0xAC101000,0xA9100000)
#define MSM_GPIO2_SIZE        SZ_4K

#define MSM_CLK_CTL_BASE      IOMEM(0xF8005000)
#define MSM_CLK_CTL_PHYS      _PHYS(0xA8600000,0xAB800000,0xA8600000)
#define MSM_CLK_CTL_SIZE      SZ_4K

#define MSM_SHARED_RAM_BASE   IOMEM(0xF8100000)
#define MSM_SHARED_RAM_PHYS   _PHYS(0x01F00000,0x00000000,0x00100000)
#define MSM_SHARED_RAM_SIZE   SZ_1M

#define MSM_UART1_PHYS        _PHYS(0xA9A00000,0xACA00000,0xA9A00000)
#define MSM_UART1_SIZE        SZ_4K

#define MSM_UART2_PHYS        _PHYS(0xA9B00000,0xACB00000,0xA9B00000)
#define MSM_UART2_SIZE        SZ_4K

#define MSM_UART3_PHYS        _PHYS(0xA9C00000,0xACC00000,0xA9C00000)
...
#define MSM_SDC1_PHYS         _PHYS(0xA0400000,0xA0400000,0xA0300000)
#define MSM_SDC1_SIZE         SZ_4K
#define MSM_SDC2_PHYS         _PHYS(0xA0500000,0xA0500000,0xA0400000)
#define MSM_SDC2_SIZE         SZ_4K
#define MSM_SDC3_PHYS         _PHYS(0xA0600000,0xA3000000,0xA0500000)
...
#define MSM_I2C_PHYS          _PHYS(0xA9900000,0xACD00000,0xA9900000)
#define MSM_I2C_SIZE          SZ_4K

#define MSM_HSUSB_PHYS        _PHYS(0xA0800000,0xA3600000,0xA0800000)
#define MSM_HSUSB_SIZE        SZ_4K

#define MSM_PMDH_PHYS         _PHYS(0xAA600000,0xAD600000,0xAA600000)
#define MSM_PMDH_SIZE         SZ_4K

#define MSM_EMDH_PHYS         _PHYS(0xAA700000,0xAD700000,0xAA700000)
#define MSM_EMDH_SIZE         SZ_4K

#define MSM_MDP_PHYS          _PHYS(0xAA200000,0xA3F00000,0xAA200000)
...
#define MSM_AD5_PHYS          _PHYS(0xAC000000,0xA7000000,~0)
